    ...
    <div class="relative overflow-auto shadow-md sm:rounded-lg">
                ...
                <RadioGroup>
                    ...
                    <div class="mt-4 grid grid-cols-1 gap-y-6 sm:grid-cols-2 sm:gap-x-4">
                        <RadioGroupOption as="template" v-for="quizCategory in quizCategories" :key="quizCategory.id"
                            :value="quizCategory" v-model=quizCategory.title v-slot="{ checked, active }">
        ...
        <div v-if="isDetailComplete" class="flex flex-col p-2 px-[30px]">
            ...
            <!-- <div class="flex gap-5 w-full">
                <button type="button"
                    class="mb-[30px] text-white bg-indigo-500 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center disabled:bg-gray-300 disabled:text-white"
                    :disabled="!this.categorySelected">Next</button>
                <button type="submit"
            ...
            <!-- <div class="flex flex-col">
                <div class="space-y-2">
                    ...
                    <input type="text" class="w-full h-8 border">

                    <div class="choices gap-1 grid grid-cols-2">
                        <div class="w-full">
                            <input type="radio" name="A" id="A" class="w-4">
                            <label for="choice1" class="font-bold">A.</label>
                            <input type="text" class="w-full h-8 border">
                        </div>
                        <div class="w-full">
                            <input type="radio" name="B" id="B" class="w-4">
                            <label for="choice2" class="font-bold">B.</label>
                            <input type="text" class="w-full h-8 border">
                        </div>
                        <div class="w-full">
                            <input type="radio" name="C" id="C" class="w-4">
                            <label for="choice3" class="font-bold">C.</label>
                            <input type="text" class="w-full h-8 border">
                        </div>
                        <div class="w-full">
                            <input type="radio" name="D" id="D" class="w-4">
                            <label for="choice4" class="font-bold">D.</label>
                            <input type="text" class="w-full h-8 border">
                        </div>
                    </div>
                </div>
