...
<template>
    <div>
        <!-- Main Content -->
        <div class="flex justify-center sm:items-center md:items-start w-auto h-screen bg-white dark:bg-[#111827]">
            <div class="flex flex-col gap-[50px] py-10 px-5 ">
                <form class="sm:h-2/5 md:h-1/5">   
                    <div>
                ...
                <!-- Result -->
                <div class="sm:h-3/5 md:h-4/5 border border-gray-200 rounded-lg shadow dark:border-gray-700 p-5">
