...
<template>
    <!-- Main Content -->
    <div class="flex flex-col justify-center items-center gap-[20px] w-full bg-white dark:bg-[#141526] p-5" :class="!hasWord ? 'h-screen' : 'h-auto'">
        <div class="flex flex-col gap-[25px] w-full md:w-[80%] lg:w-[60%]">
            ...
            <!-- Result -->
            <div class="h-auto rounded-lg dark:border-gray-700 p-5" :class="this.word === '' ? 'border-none shadow-none' : 'shadow shadow-blue-400 border-gray-200'">
                ...
                <div v-if="hasWord" class="flex flex-col gap-[10px]">
                    <div class="flex flex-col md:flex-row gap-[10px]">
                        <div class="flex flex-col items-center justify-center w-full md:w-[50%]">
                            ...
                            <p class="text text-[15px] capitalize text-gray-500 dark:text-gray-400">{{ this.dictionary.description }}</p>
                        </div>
                    ...
                    <div class="self-center relative w-full overflow-hidden aspect-video">
                        <!-- <video class="absolute inset-0 w-[100%] h-[100%] border-none " :src="this.dictionary.video_link "  frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></video>                        -->
                    </div>
                </div>
