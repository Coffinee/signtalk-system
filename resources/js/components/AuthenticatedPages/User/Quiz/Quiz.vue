<template>
    ...
    <Modal :show="modalOpen" @close="modalToggle" :title="quizTitle" :widthModal="'w-[600px]'" :heightModal="'h-auto'">
        ...
        <div class="flex flex-col gap-3 h-full">
            ...
            <router-link :to="'/quiz/main/'+quizID" class="flex items-center justify-center w-full text-white bg-indigo-600 hover:bg-indigo-700 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-indigo-600 dark:hover:bg-indigo-700">
