    ...
    <div class="flex justify-center h-auto w-full">
        <div class="h-auto w-[95%] md:w-[60%] my-[5px] shadow-md">
            ...
            <div class="flex flex-col items-center justify-center gap-[20px] h-auto  px-[15px]  py-[20px]">
                <div class=" w-full">
                    <div class="flex flex-col items-center gap-[20px] w-full" v-for="(item, index) in questions" :key="item.id">
                        <div v-if="index == quizCounter">
                            <div class="flex justify-between w-full">
                                <div class="flex items-center justify-center p-2 dark:bg-gray-600 dark:hover:bg-gray-700 rounded-full" :class="[index == 0 ? 'bg-gray-500 hover:bg-gray-600' : 'bg-indigo-500 hover:bg-indigo-600' ]">
                                ...
                                <div class="flex items-center justify-center p-2 dark:bg-gray-600 dark:hover:bg-gray-700 rounded-full" :class="[index+1 == questions.length ? 'bg-gray-500 hover:bg-gray-600' : 'bg-indigo-500 hover:bg-indigo-600' ]">
