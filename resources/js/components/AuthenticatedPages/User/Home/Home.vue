...
<template>
    <!-- <div class="bg-gray-300">
        ...
        <div class="flex justify-center items-center gap-[100px] h-screen sm:flex-col lg:flex-row lg:gap-[20px] flex-col sm:my-[120px] md:my-0">
            <div class="flex lg:gap-[20px] sm:flex-col sm:gap-[75px] md:flex-row flex-col">
