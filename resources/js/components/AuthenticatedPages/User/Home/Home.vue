            ...
            <router-link :to="isAuthenticated ?  '/student/translate' : '/translate'">
                <div
                    ...
                    <div class="flex flex-col items-center justify-center px-3 h-full">
                        ...
                        <p class="text-[12px] font-medium text-center dark:text-white text-black mt-[15px]">Translate your
                            words into Sign Language</p>
                    </div>
                </div>
            </router-link>
            <router-link :to="isAuthenticated ? '/student/dictionary' : '/dictionary'">
                <div
                    ...
                    <div class="flex flex-col items-center justify-center px-3 h-full">
                        ...
                        <p class="text-[12px] font-medium text-center dark:text-white text-black mt-[15px]">Review or add
                            words to help your colleagues</p>
                    </div>
                </div>
            </router-link>
        </div>
            ...
            <router-link :to="isAuthenticated ? '/student/quiz' : '/quiz'">
                <div
                    ...
                    <div class="flex flex-col items-center justify-center px-3 h-full">
                        ...
                        <p class="text-[12px] font-medium text-center dark:text-white text-black mt-[15px]">Test what you
                            have learned and take exams</p>
                    </div>
                </div>
            </router-link>
        </div>
        ...
        <form class="space-y-4 md:space-y-6" @submit.prevent="submitForm()">
            <div>
                ...
                <div  v-show="isTeacher == true">
                    <label for="code" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Enter Class
                        Code:</label>
                    <input type="text" name="code" id="code" placeholder="ABC123"
                        class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-indigo-600 focus:border-indigo-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                        required="true">
                </div>
            </div>
