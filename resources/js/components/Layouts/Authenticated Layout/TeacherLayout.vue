...
<template>
    ...
    -->
                    ...
                    <nav class="flex flex-1 flex-col">
                        ...
                        <li>
                            ...
                            <li v-for="item in navigation" :key="item.name">
                                <router-link :to="item.href" :class="[useRoute().path == item.href ? 'bg-indigo-700 text-white' : 'text-indigo-200 hover:text-white hover:bg-indigo-700', 'group flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold']">
                                <component :is="item.icon" :class="[useRoute().path == item.current ? 'text-white' : 'text-indigo-200 group-hover:text-white', 'h-6 w-6 shrink-0']" aria-hidden="true" />
                                {{ item.name }}
                                </router-link>
                            </li>
                            </ul>
      ...
      <div class="lg:pl-72">
        <div class="sticky top-0 flex h-16 shrink-0 items-center gap-x-4 border-b border-gray-200 bg-white z-50 px-4 shadow-sm sm:gap-x-6 sm:px-6 lg:px-8">
            ...
            <form class="relative flex flex-1" action="#" method="GET">
                ...
                <input id="search-field" class="block h-full w-full border-0 py-0 pl-8 pr-0 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm bg-white" placeholder="Search..." type="search" name="search" />
            </form>
        ...
        <main class="py-10">
            <div class="px-4 h-screen sm:px-6 lg:px-8 overflow-auto">
                <!-- YOUR CONTENT HERE -->
